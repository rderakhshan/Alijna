...
def process_item(item, model, summary_interval, prompts_type, max_steps, visual_tool, text_tool, audio_tool, memory_provider=None, direct_output_dir=None, item_id=None):
    ...
    if item.get("file_name"):
        ...
        if ".zip" in item["file_name"]:
            ...
            question += get_zip_description(
                file_path, item["question"], visual_tool, text_tool, audio_tool,
            )
        else:
