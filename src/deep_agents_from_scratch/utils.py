"""Utility functions for displaying messages and prompts in Jupyter notebooks or command-line interfaces."""
...
def format_messages(messages):
    ...
    for m in messages:
        ...
        elif msg_type_upper in ("AI", "ASSISTANT"):
            console.print(Panel(content, title="🤖 Assistant", border_style="green"))
        elif msg_type_upper == "TOOL":
